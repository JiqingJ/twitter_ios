...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "HPVm6NtyDedEQ93SMxRzzuZOo", consumerSecret: "N4FqiTP8k47CKKaKXYJQxWAbjd3FPy3Kk3CMOHowNOn8O2NS52")
    var loginSuccess: (() -> ())?
